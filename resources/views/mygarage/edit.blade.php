...
<head>
    ...
    <title>Edit Car Form - MyGarage</title>
</head>
...
<body>
    <header>
        <nav class="return-container">
            ...
            <h1 class="return-title">EDIT CAR</h1>
        </nav>
    </header>
    <main>
            ...
            <form action="/dashboard/{{$cars->id}}" method="POST" enctype="multipart/form-data">
                ...
                <div class="left-container">
                    <div class="input-container">
                        ...
                        <input type="text" id="brand" name="brand" value="{{$cars->brand}}" required><br>
                    </div>
                    <div class="input-container">
                        <label for="model">Model</label><br>
                        <input type="text" id="model" name="model" value="{{$cars->model}}" required><br>
                    </div>
                    <div class="input-container">
                    ...
                    <div class="input-container">
                        ...
                        <input type="text" id="generation" name="generation" value="{{$cars->generation}}" required><br>
                    </div>
                    <div class="input-container">
                        <label for="engine">Engine</label><br>
                        <input type="text" id="engine" name="engine" value="{{$cars->engine}}" required><br>
                    </div>
                    <div class="input-container">
